...
Product.create!(user_id: 1, name: "Nike Air Max 1 OG Bred", price: 180, description: "The latest Air Max 1 celebrates the union between pioneering silhouettes from the track and hardwood. Constructed with premium leather, the iconic runner sports a black-and-red upper as a nod to the sneaker that brought colour to basketball footwear.", gender: "mens")
Product.create!(user_id: 1, name: "Nike Air Max 1/97 SW", price: 1020, description: " Designed by vintage shoes collector Sean Wotherspoon and inspired by his passion for ’80s culture, the style merges two of his favorite models with the Air Max 1 and the Air Max 97.", gender: "mens")
Product.create!(user_id: 2, name: "Adidas Yeezy boost 350 v2 Zebra", price: 300, description: "The adidas Yeezy Boost 350 v2 “Zebra 2018” is the restocked version of the popular “Zebra” colorway that first released a year earlier.", gender: "mens")
Product.create!(user_id: 2, name: "Air Jordan 1 Bred", price: 895, description: "Jordan Brand reintroduced the 'OG' versions of the Jordan 1, which featured 'Nike Air' labeling on the tongue and on the insoles back in 2013.", gender: "mens")
