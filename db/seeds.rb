...
User.create!(name: "Tony", email: "tony@example.com", phone_number: "7731111111", password: "password")
User.create!(name: "Jane", email: "jane@example.com", phone_number: "2221113333", password: "password")

Product.create!(user_id: 1, name: "Nike Air Max 1 OG Bred", price: 180, description: "The latest Air Max 1 celebrates the union between pioneering silhouettes from the track and hardwood. Constructed with premium leather, the iconic runner sports a black-and-red upper as a nod to the sneaker that brought colour to basketball footwear.", gender: "mens", supplier_id: 1)
Product.create!(user_id: 1, name: "Nike Air Max 1/97 SW", price: 1020, description: " Designed by vintage shoes collector Sean Wotherspoon and inspired by his passion for ’80s culture, the style merges two of his favorite models with the Air Max 1 and the Air Max 97.", gender: "mens", supplier_id: 1)
Product.create!(user_id: 1, name: "Adidas Yeezy boost 350 v2 Zebra", price: 300, description: "The adidas Yeezy Boost 350 v2 “Zebra 2018” is the restocked version of the popular “Zebra” colorway that first released a year earlier.", gender: "mens", supplier_id: 2)
Product.create!(user_id: 1, name: "Air Jordan 1 Bred", price: 895, description: "Jordan Brand reintroduced the 'OG' versions of the Jordan 1, which featured 'Nike Air' labeling on the tongue and on the insoles back in 2013.", gender: "mens", supplier_id: 1)
...
Product.create!(user_id: 1, name: "Nike Air Max 1 Atmos Elephant", price: 895, description: "The Atmos x Air Max 1 'Elephant' 2017 was a re-release of a 2006 collaboration with Tokyo-based brand Atmos. The winner of the 2016 Vote Back contest, the design combines a black suede upper with a white toe box, elephant print overlays, and clear jade accents. Re-released on Air Max Day, the sneaker also comes with a white midsole and black outsole.", gender: "mens", supplier_id: 1)
Product.create!(user_id: 1, name: "Adidas Yeezy boost 350 v2 Desert Sage", price: 250, description: "The Yeezy Boost 350 V2 'Desert Sage' is outfitted in a pale green Primeknit upper with tonal rope laces and reflective detailing on the sneaker’s signature side stripe. Contrast pops of color emerge on the orange collar lining and sockliner, the latter printed with dual adidas and Yeezy branding.", gender: "mens", supplier_id: 2)
Product.create!(user_id: 1, name: "Adidas Yeezy boost 350 v2 Earth", price: 255, description: "The Yeezy Boost 350 V2 'Earth' makes use of a Primeknit upper in a monochromatic dark khaki hue, complete with a post-dyed monofilament side strip for textural variety and a textile heel tab for easy on and off.", gender: "mens", supplier_id: 2)
